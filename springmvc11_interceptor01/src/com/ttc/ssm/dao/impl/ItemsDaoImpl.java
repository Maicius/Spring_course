...
public class ItemsDaoImpl implements ItemsDao{
	...
	static{
		...
		itemList.add(new ItemsCustom(1,"冰箱", 5000.0f, null,new Date(),"冰箱质量好价格低" ));
		itemList.add(new ItemsCustom(2,"洗衣机", 2000.0f, null,new Date(),"洗衣机质量好价格低" ));
		itemList.add(new ItemsCustom(3,"笔记本电脑", 8000.0f, null,new Date(),"笔记本电脑质量好价格低" ));
		itemList.add(new ItemsCustom(4,"空调", 2000.0f, null,new Date(),"空调质量好价格低" ));
		itemList.add(new ItemsCustom(5,"彩电", 6000.0f, null,new Date(),"彩电质量好价格低" ));
	}
